...
Implementors: N/A
Discussions: 
  - [PR](https://github.com/cardano-foundation/CIPs/pull/xxx)
Created: 2025-04-22
License: CC-BY-4.0
---
...
This CIP defines the procedure for assigning SRV prefixes for Cardano applications (like `cardano-node`, `mithril`, etc.).

## Motivation

The **Cardano Ledger** allows the use of SRV records in the **SPO** registration certificate.
...
SRV records were designed to make deployment independent of hard-coded service end-points (see [RVC#2782]).
...
| _mithril_ | `_mithril._tcp` | Active |
...
[CIP#137]: https://github.com/cardano-foundation/CIPs/tree/master/CIP-0137
