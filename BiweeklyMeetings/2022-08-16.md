...
**Robert Phair** -: As far as using the equations in CIPs and in GitHub content, the difficulty they ran into with another CIP 50, did they ever work out the presentation of those tech type equations on the mobile platform? Someone said they weren't working.

**Matthias** -: So there is only Christoff on the chat commenting that. Yeah, they have done equations on GitHub, prone to some issues as you learn from CIP 50. So you are saying it's specifically on a mobile device, that it is not supported yet?

**Robert Phair** -: That's what I think Christoff was saying.
...
**Robert Phair** -: I get it. I hadn't thought of it that way. If they could go back to the original store. So if they want to see that kind of detail in the equations.

**Matthias** -: Probably, it looks good in VS Code than Jupyter Notebooks, said Christoff. But then in GitHub and stuff, can't render, I guess, does not render on mobile in brackets, in desktop. I can't speak if, yeah, not, actually, since you are here, it'll faster than just writing on the chat. Can we just unmute you. Yes, it's done.

**Christoff** -: Can you guys hear me?

**Robert Phair** -: Yes. Hello?

**Christoff** -: Oh, Hey everybody. Yeah. So as I learned in C50, yeah, the mobile definitely doesn't render, but then there's some brackets, especially curly brackets that doesn't render on GitHub even on desktop. So that's why we reverted back to basically screenshot equations from external source. Pictures.

**Matthias** -: Is it a problem from GitHub specifically, or is it [inaudible 00:03:54] general that is just-

**Christoff** -: No it's specifically GitHub and I did some digging and I don't know, I guess the layman's interpretation, it was something with like Java... Sorry, I just got a call. JavaScript rendering on the website itself with GitHub. And there were some conflicts and it seems like a mess, but it'll look good in VS Code and even Jupyter Notebooks and just regular [inaudible 00:04:25] it's fine. But when it's in GitHub read me, it breaks. So you have to add some extra back slashes and curly brackets and yeah, we eventually just reverted back. For simpler equations, it is probably okay. But for more complex things, it breaks it seems.
...
**Christoff** -: Yeah. If it works great, but yeah, just be prepared to check.
...
**Christoff** -: I personally haven't reviewed it, but now I will. I wasn't that aware it so...

**Matthias** -: Good. That's why we have the meetings then.

**Christoff** -: But I'll do that.
...
**Robert Phair** -: You saw when you, at the [inaudible 00:10:43] when you looked over that there was a suggestion that the Mac addressed at the machine might be considered relevant to the point of CIP 45. And I've suggested that maybe that should be moved off to the Cardano forum and kept out of this CIP 45 discussion on GitHub. I believe it's relevant to the CIP as stated and, I think the rationale for doing that is not correct.
...
**Andrew** -: Yeah. We've had several two-hour meetings with people. There were 20 different groups in the room, either producing music on Cardano or representing wallets or players or things like that. So yeah, I will add to the rational section before the next meeting that this comes up.
...
**Matthias** -: And this is something I would love to see in the rational section as well. Exactly what you just explained. This is a collaborative effort between actual people building with, in the music industry, on, kind of, i don't know, the blockchain in general and that's also why we justifying some of the choices that have been made.
**Andrew** -: Okay.
...
**Andrew** -: Yeah. We've had several two hour meetings with people. There was 20 different groups in the room, either producing music on Cardano or representing wallets or players or things like that. So yeah, I will add to the rational section before next meeting that this comes up.
