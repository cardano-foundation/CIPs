...
#### Runtime
We performed some benchmarks on the curve operations. The relation presented above was evaluated using the arkworks 
framework for simplicity. Further tests are planned using the optimized BLST library. We performed some quick 
benchmarks for signature related operations using the optimized library, and got the following results: 
* Signature verification (2 pairings plus equality check): 1.0909 ms
* G1 addition: 490 ns
* G2 addition: 1,7 us
* G1 multiplication: 546us
* G2 multiplication: 100us
...
* n G_1 additions and 1 G_1 negation [WE NEED TO ADD THIS]
* 2 pairing evaluations + equality check
...
* 6 hash computations
* 1 vanishing polynomial (1 scalar exponantiation) [NEED TO ADD THIS]
