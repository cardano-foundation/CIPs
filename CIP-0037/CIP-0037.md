...
* Group operations: 
    ...
    * `BLS12_381_H2G1 :: ByteArray -> BLS12_381G1Element`
...
* Pairing operations:
    * `BLS12_381_pairing :: BLS12_381G1Element -> BLS12_381G2Element -> BLS12_381GTElement`
...
* Deserialisation: 
  ...
  * `deserializeG2 :: ByteString -> (BLSTError -> a) -> (Bls12_381G2Element -> a) -> a`
* Equality functions:
...
and verify that the result is the identity element. In other words, the equality check function, `final_verify`, first
...
* [Ethereum support for BLS12_381](https://eips.ethereum.org/EIPS/eip-2537). Not directly relevant as this is a 
