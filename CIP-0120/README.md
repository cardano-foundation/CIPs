...
Legibility should be kept in mind.
...
immutably on a distributed storage mechanism such as IPFS.
Where backups can be easily made in a permissionless manner by 
interested parties.
...
My choosing a common format, 
we drastically improve the accessibility of the document.
...
keeping the Cardano Constitution on Cardano seems sensible.
