...
The lack of an on-chain communication standard between the stake pool owner and their delegates.
...
Metadata are written in JSON format and maximum size of metadata is 16KB.
