...
The implementation format in this CIP should be the ground base for transactions messages/comments/memos and should be respected by creator-implemantations as well as in receiver-implementations.
